...
//     }
//         this.shiphull = Math.round(Math.random()*(6-3)+3 //enemy hull is between 3 and 6
//      this.firepower =Math.round(Math.random)
//     }
...
// creating sub class extending from the parent class and changing the values of the same paramaters 
...
// class Ship{
//     constructor(shiphaul, firepower, accuracy ){
//     this.shiphaul= shiphaul
//     this.firepower = firepower
//     this.accuracy = accuracy
// }
// }
...
// // var randomNumber = Math.random(Math.random ()*20)+1;
